...
<div class="wrapper">
	...
	<fieldset>
		...
		<form class="form" id="form" action="<?php echo base_url('admin/admin/edit/'.$info->idemployee);?> " method="post" enctype="multipart/form-data">
				<div class="formRow">
				...
				<div class="formRow">
					...
					<div class="formRight">
					<span class="oneTwo"><input name="address" id="param_address" _autocheck="true" type="text" value="<?php echo $info->address; ?>"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
					<span class="oneTwo"><input name="phone" id="param_phone" _autocheck="true" type="text" value="<?php echo $info->phonenumber; ?>"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
					<span class="oneTwo"><input name="position" id="param_position" _autocheck="true" type="text" value="<?php echo $info->position; ?>"></span>
